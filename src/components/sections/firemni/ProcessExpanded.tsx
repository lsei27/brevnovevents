          ...
          {steps.map((step, index) => (
            <div key={step.number} className="relative text-center">
              ...
              <div className="relative">
                <span className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-brand-red text-2xl font-black">
                  {step.number}
                </span>
              </div>
          ...
          {steps.map((step) => (
            <div key={step.number} className="flex gap-4">
              <div className="flex flex-col items-center">
                <span className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-red text-xl font-black">
                  {step.number}
                </span>
